...
const goToForm = () => {
    router.get(`/form/${props.accessLevel.id}?lang=${lang}`)
}
</script>
...
<template>
    ...
    >
        ...
        <p class="pt-3 px-4" :class="{rtl: lang === 'arabic'}" v-html="lang === 'english' ? accessLevel?.general_settings?.description : accessLevel?.general_settings?.description_arabic"/>
